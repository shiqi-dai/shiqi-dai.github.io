...
[**Procedural Level Generation with Diffusion Models from a Single Example**](https://ojs.aaai.org/index.php/AAAI/article/view/28865)
...
<!-- [**Paper**](https://scholar.google.com/citations?view_op=view_citation&hl=zh-CN&user=qA08X4sAAAAJ&citation_for_view=qA08X4sAAAAJ:u5HHmVD_uO8C) <strong><span class='show_paper_citations' data='qA08X4sAAAAJ:u5HHmVD_uO8C'></span></strong> -->
...
<!-- - Our approach involves two core components: 1.an efficient yet expressive level representation, and 2.a latent denoising network with constrained receptive fields.  -->
...
<code class="language-plaintext highlighter-rouge">Under Review</code> <strong>EMABench: Evaluating Multimodal Large Language Models as Embodied Agents</strong>, Zhili Cheng, Yuge Tu, Yang Shi, Jinyi Hu, Ran Li, Shengding Hu, <strong>Shiqi Dai</strong>, Tianyu Yu, Lei Shi, Zhiyuan Liu, Maosong Sun.
